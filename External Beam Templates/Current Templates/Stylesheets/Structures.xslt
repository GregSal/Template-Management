			...
			<table border="0" cellpadding="1" cellspacing="1">
				<thead class="tableheader">
					<tr align="center" valign="middle">
						...
						<td width="120">Structure code</td>
				...
				<tbody class="tablebody">
					<xsl:for-each select="Structure">
						<tr align="center" valign="middle">
							...
							<xsl:value-of select="Identification/VolumeType"/><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
							<xsl:value-of select="Identification/VolumeCode"/><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
							<xsl:value-of select="Identification/VolumeCodeTable"/>
							</td>
							<td width="120">
								<xsl:value-of select="Identification/StructureCode/@Code"/><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
								<xsl:value-of select="Identification/StructureCode/@CodeScheme"/><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
								<xsl:value-of select="Identification/StructureCode/@CodeSchemeVersion"/>
							</td>
