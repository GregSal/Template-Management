        ...
        <xsl:for-each select="msxsl:node-set($SortedBeams)/Beam">
          ...
          <table class="indented" style="page-break-inside: avoid;">
            ...
            <tr>
              ...
              <td class="indented">
                Set gantry start angle to <xsl:value-of select="format-number(GantryStartAngle, '##0.0')"/><xsl:value-of select="GantryStartAngle/@Unit"/>.
              </td>
            </tr>
            <xsl:if test="GantryDirection != 'NONE'">
              <tr>
                ...
                <td class="indented">
                  Set gantry end angle to <xsl:value-of select="format-number(GantryStopAngle, '##0.0')"/><xsl:value-of select="GantryStopAngle/@Unit"/>.
                </td>
              </tr>
            </xsl:if>
