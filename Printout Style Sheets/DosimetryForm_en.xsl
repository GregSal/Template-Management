       ...
       use a <xsl:choose> -structure such as
          <xsl:choose>
            <xsl:when test="string(number(/PlanReport/DosePerFraction)) != 'NaN'">
              <xsl:value-of select="format-number(/PlanReport/DosePerFraction, '0.00 ')"/>
    ...
    <html>
      ...
      <body>
        ...
        <ul>
          ...
          <li>Isocenter coordinates are given using the <xsl:value-of select="/PlanReport/PlanningCoordinateSystem"/> coordinate system.</li>
        </ul>
            ...
            <xsl:for-each select="msxsl:node-set($SortedTreatmentBeams)/Beam">
              ...
              <tr>
                ...
                <td class="fixed right" width="50px">
                  ...
                  <xsl:value-of select="GantryStartAngleExtended"/>
                ...
                <td class="fixed right" width="50px">
                  <xsl:if test="GantryDirection != 'NONE'">
                    ...
                    <xsl:value-of select="GantryStopAngleExtended"/>
        ...
        <xsl:if test="count(/PlanReport/PlanValidationList/PlanValidationItem) > 0">
          <h2>Planning Approval Validation</h2>
          <table>
            <xsl:for-each select="/PlanReport/PlanValidationList/PlanValidationItem">
              <tr>
                <td style="padding-top:8px; padding-bottom:8px; vertical-align:top; white-space:nowrap;">
                  <xsl:value-of select="First"/>
                </td>
                <td style="padding-top:8px; padding-bottom:8px; padding-left:10px; vertical-align:top;">
